...
const DiseaseTrackingSplashPage: NextPage = () => {
    const { t } = useTranslation('common');
    const id = "diseaseTracking";
    ...
    return (
      <>
        <Head>
          ...
          <meta name="description" content={t('diseaseTrackingDescription')} />
...
export default DiseaseTrackingSplashPage;