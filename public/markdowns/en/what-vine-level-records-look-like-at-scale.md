---
title: "What Vine-Level Records Look Like at Scale: Lessons from a 184,000-Vine Estate"
description: "Inside a real-world deployment of vine-by-vine digital records across three vineyards, 57 blocks, and 35 years of planting history. How one premium Napa estate replaced spreadsheets with GPS-verified vine records."
keywords:
  - vineyard management software
  - vine tracking
  - vineyard record keeping
  - digital vineyard management
  - vine-by-vine records
  - vineyard GPS mapping
  - RTK GPS vineyard
  - vineyard replant tracking
...
| Metric | Value |
|---|---|
| Vines individually recorded | 183,996 |
| Blocks managed | 57 |
| Vineyards | 3 |
| Varieties tracked | 4 |
| Rootstock combinations | 6 |
| Years of planting history | 35 |
| Team logins (cumulative) | 978 |
| Saved queries | 74 |
...
1. **Initial mapping**: Walk the vineyard with an RTK GPS receiver. Each vine gets a GPS coordinate and basic attributes (variety, rootstock, planting year, status). For a 200-acre estate, this takes a few weeks of field work spread across normal operations.

2. **Daily use**: Once the base map exists, the crew adds observations during their normal walks. Disease flags, replant tracking, and status updates happen in real time on mobile devices.

3. **Query building**: As data accumulates, the team starts building saved queries for recurring questions. "Show me all Cab Sauv on 101-14 rootstock planted before 2000" or "Which blocks have more than 10% miss rate?"

4. **Institutional asset**: After one to two seasons, the vine records become the authoritative source of truth for the estate. New team members onboard by looking at the data, not by asking whoever has been there longest.
...
*Ready to see how vine-level records would work for your estate? [Schedule a demo](https://scheduler.zoom.us/d/1i222xhk/sentinel-demo) and we will walk through the platform using your vineyard's layout.*
