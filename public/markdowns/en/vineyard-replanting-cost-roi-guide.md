---
title: "The Vineyard Replant Decision: When the Data Says Pull, When It Says Wait"
description: "Vineyard replanting costs $50K-$80K per acre in Napa Valley. Vine-level data transforms the replant decision from a gut call into a precise ROI calculation -- partial replant, phased roguing, or full pull."
keywords:
  - vineyard replanting cost
  - vineyard replant ROI
  - when to replant vineyard
  - vineyard replanting
  - partial vineyard replant
  - vine replacement economics
  - replant planning
  - vineyard lifecycle management
author: "Christian Sidak"
date: "2026-04-22"
image: "/img/blog/replant-decision.webp"
---
...
- 4,200 total vines
- 630 vines (15%) flagged positive for red blotch over two seasons of [vine-level disease tracking](/blog/vine-level-disease-tracking-program)
...
**3. Management differentiation.** Young and mature vines in the same block need different irrigation, canopy management, and crop load targets. This logistical challenge is why vineyard managers historically avoided partial replants. But with a [vine-level management system](/rapidMapping) that tracks the plant year of every vine and generates [work orders](/workOrders) by vine age and status, the complexity becomes tractable.

**4. Harvest segregation.** Young-vine fruit should not go into the same lot as mature-vine fruit until the winemaker is satisfied with quality. Vine-level records tell the crew exactly which vines are young, enabling clean harvest separation. For a deeper look at how [vineyard management software](/blog/vineyard-management-software-buyers-guide-2026) handles these workflows, see our buyer's guide.
...
| | Full Replant (10 acres) | Partial Replant (3 acres) |
|---|---|---|
| Direct replant cost | $150,000 - $250,000 | $45,000 - $75,000 |
| Lost revenue (3-4 years) | $720,000 - $1,920,000 | $216,000 - $576,000 |
| Revenue from kept vines | $0 | $504,000 - $1,344,000 over 4 years |
| Total cost | $870,000 - $2,170,000 | $261,000 - $651,000 |
| Revenue preservation | None | 70% of block stays in production |
...
**Rogue and monitor** when infection is below 15%, spatially contained, the clean vines are strong, and your [disease tracking program](/blog/vine-level-disease-tracking-program) catches new infections early.

**Wait and collect more data** when you have only one season of vine-level data, the decline has not been definitively attributed to a cause, or capital is constrained. Waiting is not ignoring -- it means actively [tracking disease at the vine level](/diseaseTracking) so next year's decision is better informed.
...
If you are facing a replant decision -- or want to build the data foundation before you need one -- [schedule a demo of Sentinel Vine Manager](https://scheduler.zoom.us/d/1i222xhk/sentinel-demo). We will walk through your specific blocks, show you how vine-level spatial analysis changes the replant calculus, and help you build a replant plan grounded in data rather than assumption.
