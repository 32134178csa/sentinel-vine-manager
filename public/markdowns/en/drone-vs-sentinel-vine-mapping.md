...
- **Custom vine records**: Track Red Blotch status, production status, interplant date, and even attach photos to vines.
- **Operational integration**: Create work orders, assign tasks, and automatically update vine statuses based on activity.
